            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <button
                  ...
                  className="px-6 py-3 rounded-xl font-bold shadow-lg border-2 transition-colors duration-200 bg-[#d0ebff] hover:bg-[#bfe5ff] text-[#003b46] border-[#00ccff] focus:outline-none focus:ring-4 focus:ring-[#00ccff]/30"
                >
                  Clear
                </button>
              </div>
